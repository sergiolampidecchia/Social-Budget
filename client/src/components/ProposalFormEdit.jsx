...
export default function ProposalFormEdit(props) {
    const {id} = useParams();
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try{
            await API.updateProposal(id, description, budget);
            alert("You have updated a new proposal!");
